...
'''	
	...
	for ts in u.trajectory:
		...
		if (ts.frame == 0) or (ts.frame % 100 == 0):
			...
			LR_BB = u.select_atoms('name BB and segid A')
			LR_BB_coordinates.append(LR_BB.positions)

			Leptin_BB = u.select_atoms('name BB and segid B')
			Leptin_BB_coordinates.append(Leptin_BB.positions)
...
https://docs.mdanalysis.org/2.0.0/documentation_pages/overview.html
https://www.mdanalysis.org/MDAnalysisTutorial/trajectories.html
