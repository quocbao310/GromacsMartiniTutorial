...
if __name__ == "__main__":
	...
	PCA = [i.strip().rsplit('   ',1) for i in PCA]
	...
	for i in coords:
		...
		commands.append('Command just used: ' + 'gmx_2021.2 trjconv -f /home/quocbao/course/python_course/pyqtgraph/PCA_manipulation/public/WT600.xtc -s /home/quocbao/course/python_course/pyqtgraph/PCA_manipulation/public/WT600.tpr -dump ' + str(int(index) * 10) + ' -o frame_' + str(PC1[index]) + '_' + str(PC2[index]) + '_' + str(int(index) * 10) + '.pdb')		
