...
# Update system.top: #include "/home/quocbao/Document/Teaching_gromacs/mdp/martini_v3.0.0.itp"
...
# Fix pbc 
gmx_mpi trjconv -s ../simulation_space/prod.tpr -f ../simulation_space/prod.xtc -o prod_noPBC.xtc -pbc nojump -center -ur compact

gmx_mpi trjconv -f prod_noPBC.xtc -s ../simulation_space/prod.tpr -dump 0 -o frame0.pdb
